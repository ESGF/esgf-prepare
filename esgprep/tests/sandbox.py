...
from esgprep.tests.test_local import (clean, esgdrs_latest, esgdrs_make,
                                      esgdrs_remove, one_file_dataset_path_v1,
                                      one_file_dataset_path_v2,
                                      root_reconstruct)
...
def DoWork():
    clean()
    esgdrs_make(
        "/home/ltroussellier/Bureau/dev/bddFromCiclad/scenario1/etape1",
        "CMIP6",
        root_reconstruct,
        "v20180802",
    )
...
def DoWork2():
    clean()
    esgdrs_make(
        "/home/ltroussellier/Bureau/dev/bddFromCiclad/bdd/CMIP6/CMIP/EC-Earth-Consortium/EC-Earth3/historical/r21i1p1f1/Omon/volo/gn/v20190725",
        "CMIP6",
        root_reconstruct,
        "v20190725",
    )
...
def test2():
    d = Path(
        "/home/ltroussellier/Bureau/dev/bddFromCiclad/reconstruct_bdd/CMIP6/CFMIP/IPSL/IPSL-CM6A-LR/amip-m4K/r1i1p1f1/Amon/n2oglobal/gr/latest"
    ).resolve()
    print(d)
