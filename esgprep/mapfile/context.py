...
from esgprep.mapfile.constants import WORKING_EXTENSION
...
class ProcessingContext(MultiprocessingContext):
    ...
    def clean(self):
        ...
        """
        msg = 'Removing incomplete mapfiles with "{}" extension in "{}" -- '.format(
            WORKING_EXTENSION, self.outdir
        )
