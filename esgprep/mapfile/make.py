    ...
    def __call__(self, source):
        ...
        try:
            ...
            try:
                ...
                print(f"Warning: Modern processing unavailable ({ie}), falling back to legacy approach")
                return self._handle_legacy_file(source)
                
            except Exception as e:
                # If modern approach fails for any other reason, try legacy approach
                print(f"Warning: Modern processing failed ({e}), falling back to legacy approach")
