...
RETRY_FROM_HELP = """Retry only previously failed files. Takes the path to a ".esgprep_failed.txt" file generated by a previous run. When provided, only the files listed in that file are processed instead of scanning directories.
